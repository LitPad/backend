...
const docTemplate = `{
    ...
    "paths": {
        ...
        "/admin/books/book-detail/{slug}/reading-progress": {
            "get": {
                "security": [
                    {
                        "BearerAuth": []
                ...
                "parameters": [
                    ...
                    },
                    {
                        "type": "string",
                        "default": "12_months",
                        "description": "Time Range to filter by (12_months, 30_days, 7_days)",
                ...
                "responses": {
                    "200": {
                        "description": "OK",
                        "schema": {
                            "$ref": "#/definitions/schemas.BookReadingProgressResponseSchema"
                        }
                    },
                    "400": {
                        "description": "Bad Request",
        ...
        "/admin/books/book-detail/{slug}/retention-stats": {
            "get": {
                "security": [
                    {
                        "BearerAuth": []
                ...
                "responses": {
                    "200": {
                        "description": "OK",
                        "schema": {
                            "$ref": "#/definitions/schemas.BookRetentionStatsResponseSchema"
                        }
                    },
                    "400": {
                        "description": "Bad Request",
    ...
    "definitions": {
        ...
        "schemas.BookReadingProgressResponseSchema": {
            "type": "object",
            "properties": {
                "data": {
                    "type": "array",
                    "items": {
                        "$ref": "#/definitions/schemas.BookReadingProgressSchema"
                    }
                },
                "message": {
                    "type": "string",
        ...
        "schemas.BookReadingProgressSchema": {
            "type": "object",
            "properties": {
                "completion_rate": {
                    "type": "number",
        ...
        "schemas.BookRetentionStatsResponseSchema": {
            "type": "object",
            "properties": {
                "data": {
                    "$ref": "#/definitions/schemas.RetentionStatsSchema"
                },
                "message": {
                    "type": "string",
                    "example": "Data fetched/created/updated/deleted"
